...
def main():
    ...
    try:
        ...
        if os.path.exists("song_metadata.yml"):
            ...
            if not has_changes:
                print("No changes detected in song_metadata.yml")
                return
            ...
            logging.info("\nSuccessfully completed song metadata generation")
